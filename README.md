...
Morsecoder is a ruby program that takes in a morse code and decodes it to english.
...
Feel free to check the [issues page](https://github.com/Fombi-Favour/morse-code/issues).
